...
async function loadElementData() {
  ...
  function showElementForPcInfo(elementSymbol) {
    ...
    // Set the content of the modal
    const modalContent =    
    `<model-viewer class="user" src="${element.bohr_model_3d}" ar ar-modes="webxr scene-viewer quick-look" camera-controls field-of-view="60deg" tone-mapping="neutral" poster="poster.webp" shadow-intensity="1">
